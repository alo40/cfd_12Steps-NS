...
Today's 21.06.2020, getting close to the final step, I'm excited :)
"""
...
def animate(n):
    ...
    dt = mi.timeStep_NS(cx, cy, dx, dy, Co, Nu, rho)
    u, v, p = mi.stencil_NS_noSource(u, v, p, dx, dy, dt, Nu, rho)
